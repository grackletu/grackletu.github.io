...
<div style="text-align=center;"><img style="width:80%; padding-bottom:40px;" src="../assets/images/seds-soils.svg"></div>
...
Typically, rocks form in equilibrium with an environment that is substantially different from the Earth's surface. The chemical changes of sediments and soil from their parent (rock) material reflects the process of re-equilibration with the Earth surface environment. We reconstruct these histories of equilibration with (near) surface environments by examining the [elemental](methods#elemental-analysis) and [isotopic](methods#mass-spectrometry) properties of sediments and soil.
